...
function makeHeader(){
  ...
  function mainTab() {
    ...
    newTodoButton(_projects_js__WEBPACK_IMPORTED_MODULE_2__.projects[0]);
    });
  ...
  function tabColor () {
    ...
    return colors[`${_projects_js__WEBPACK_IMPORTED_MODULE_2__.projects.length-2}`]
  }
