...
function makeHeader(){
  ...
  function makeTabsHeader(){
    ...
    iconContainer.addEventListener('click', () => {
      (0,_projectsoptions__WEBPACK_IMPORTED_MODULE_3__.openProjectOptions)();
      }, {once : true});
  ...
  function newTabButton() {
    ...
    btn.addEventListener('click', () => {
     ;(0,_domforms_js__WEBPACK_IMPORTED_MODULE_0__.editProjectName)(btn);
    }, {once : true});
...
function nameInput (value) {
  ...
  function dueDateInput (date){
    ...
    if(date){input.setAttribute('value', date);
        ...
        let now = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(), 'yyyy-MM-dd');
