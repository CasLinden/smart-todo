...
function nameInput (value) {
  ...
  function dueDateInput (date){
    ...
    if(date){input.setAttribute('value', date);
        ...
        let now = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(), 'yyyy-MM-dd');
  ...
  function editTodoForm(todo, project){
    ...
    let due = (0,_todos_js__WEBPACK_IMPORTED_MODULE_0__.findTodoObj)(todo, project).due
